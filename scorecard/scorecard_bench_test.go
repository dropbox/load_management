...
var requests = [][]Tag{
	...
	{"source:cape_yss_workers_FakeTopology_FakeLambda-fake_lambda.py", "client_id:taskrunner_prod", "op:read_gid2", "op:read_gid2", "traffic:live_traffic"},
	...
	{"source:cape_yss_workers_FakeTopology_FakeLambda-fake_lambda.py", "client_id:megaphone_journey_builder", "op:prepare_xtxn", "op:read_ep", "traffic:batch_traffic"},
	...
	{"source:cape_yss_workers_FakeTopology_FakeLambda-fake_lambda.py", "client_id:cape_dispatcher", "op:read_gid2", "op:prepare_xtxn", "traffic:batch_traffic"},
